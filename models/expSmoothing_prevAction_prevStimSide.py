...
class expSmoothing_prevAction_prevStimSide(model.Model):
    """
    ...
    def __init__(
        ...
        name = "expSmoothing_prevAction_prevStimSide" + "_single_zeta" * single_zeta
        if single_zeta:
        ...
        for t in range(act.shape[-1]):
            if t > 0:
                ...
                values_s[:, :, t] = (1 - alpha_s) * values_s[
                    :, :, t - 1
                ] + alpha_s * torch.unsqueeze(s_prev.T, 1)
